...
// ********  CREATE LEAD  *************/
    ...
    public void createLead(LeadRequestDTO leadRequestDTO, Long id) {
        ...
        lead.setCompany(companyService.findCompanyById(id));
...
//********* GET LEAD ***************/
    ...
    public LeadResponseDTO getLeadById(Long id) {
        ...
        leadResponseDTO.setCompany((lead.getCompany()).getName());
